...
### Squarespace placement (Code Injection)
...
3) Scroll to **Marketing Tools** → **Custom Code**.  
4) Click **Code Injection**.  
5) You’ll see **Header** and **Footer** sections—paste the integration script below into **Footer**.  
6) Click **Save**.  
7) Refresh your live site and open the page where chat should load to verify.
