...
- In the Wix Editor, add **Embed → Embed a Widget** to your page and switch it to **Code** mode.  
- Add the chat-embed script once in **Settings → Custom Code → Head** or place it at the top of the embed code:

```html
<script defer src="https://cdn.jsdelivr.net/npm/@cometchat/chat-embed@1.x.x/dist/main.js"></script>
```

- Then, inside the same embed, paste the snippet for your chosen sign-in option below. Use the resize handles on the embed element for width/height.
