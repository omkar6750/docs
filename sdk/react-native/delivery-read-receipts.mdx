...
```json
{
  ...
  "lastMessage": {
    ...
    "sentAt": 1772006074,
    "deliveredAt": 1772006158,
    "readAt": 1772006158,
    "updatedAt": 1772006158
  },
  "latestMessageId": "",
  "conversationWith": {
    "hasBlockedMe": false,
...
```json
{
  ...
  "sender": {
    ...
    "name": "Henry Marino",
    "avatar": "https://assets.cometchat.io/sampleapp/v2/users/cometchat-uid-7.webp",
    "lastActiveAt": 1771853565,
    "role": "default",
    "status": "online",
    "tags": []
  },
  "receiverType": "user",
  "receiver": "cometchat-uid-6",
  "deliveredAt": 1772005348,
  "messageId": "25323",
  "timestamp": 1772005348
}
```
...
```json
{
  ...
  "receiverType": "group",
  "receiver": "tg1",
  "deliveredAt": 1772005516,
  "messageId": "25325",
  "timestamp": 1772005516
}
```
