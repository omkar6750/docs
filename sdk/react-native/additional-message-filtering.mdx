...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (includes both `custom` and `message` categories):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (only `image`, `video`, `audio`, `file` types):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (threaded replies are excluded, parent messages with threads still appear):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (deleted messages are excluded):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (messages include the `tags` field):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (only messages containing links):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (only messages with attachments):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (only messages that have reactions):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (only messages that contain mentions):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (only messages mentioning the specified UIDs):
```json
[
  {
    "reactions": [],
...
<Accordion title="Sample Console Output">
**On Success** — `fetchPrevious()` returns (only messages with the specified attachment types):
```json
[
  {
    "reactions": [],
