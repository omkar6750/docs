...
<Accordion title="Sample Payload - AppSettings with Extension Group ID">
...
<Accordion title="Sample Payload - markAsDelivered from Push Notification">
...
<Accordion title="Sample Payload - Push Notification for User Message">
...
<Accordion title="Sample Payload - Push Notification for Group Message">
...
<Accordion title="Sample Payload - When to Use markAsDelivered">
