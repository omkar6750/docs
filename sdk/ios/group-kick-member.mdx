...
When fetching previous messages, kick/ban/unban actions appear as `Action` messages (a subclass of `BaseMessage`).
...
| `actionBy` | [User](/sdk/ios/users-overview#user-properties) | The user who kicked the member |
| `actionOn` | [User](/sdk/ios/users-overview#user-properties) | The member who was kicked |
| `actionFor` | [Group](/sdk/ios/retrieve-groups#group-properties) | The group |
...
| `actionBy` | [User](/sdk/ios/users-overview#user-properties) | The user who banned the member |
| `actionOn` | [User](/sdk/ios/users-overview#user-properties) | The member who was banned |
| `actionFor` | [Group](/sdk/ios/retrieve-groups#group-properties) | The group |
...
| `actionBy` | [User](/sdk/ios/users-overview#user-properties) | The user who unbanned the member |
| `actionOn` | [User](/sdk/ios/users-overview#user-properties) | The member who was unbanned |
| `actionFor` | [Group](/sdk/ios/retrieve-groups#group-properties) | The group |
