...
<Tab title="Request">
```swift
// CometChat.markAsDelivered - REQUEST
messageId: 37799
messageSender: cometchat-uid-3
...
```swift
// CometChat.markAsDelivered - SUCCESS
status: success
```
</Tab>
<Tab title="Error Response">
```swift
// CometChat.markAsDelivered - ERROR RESPONSE
// Object Type: CometChatException

errorCode: ERROR_INTERNET_UNAVAILABLE
errorDescription: No internet connection available. Please check your network settings.
```
</Tab>
</Tabs>
</Accordion>
...
<Tab title="Success Response">
```swift
// CometChat.markAsRead - SUCCESS
status: success
```
</Tab>
<Tab title="Error Response">
```swift
// CometChat.markAsRead - ERROR RESPONSE
// Object Type: CometChatException
