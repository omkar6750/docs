...
| `actionOn` | [User](/sdk/ios/users-overview#user-properties) | The new owner |
| `actionBy` | [User](/sdk/ios/users-overview#user-properties) | The previous owner who transferred |
| `actionFor` | [Group](/sdk/ios/retrieve-groups#group-properties) | The group where change occurred |
