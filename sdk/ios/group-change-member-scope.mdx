...
| `actionOn` | [User](/sdk/ios/users-overview#user-properties) | The user whose scope changed |
| `actionBy` | [User](/sdk/ios/users-overview#user-properties) | The user who changed the scope |
