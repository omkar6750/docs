...
| `actionBy` | [User](/sdk/ios/users-overview#user-properties) | The user who left |
| `actionFor` | [Group](/sdk/ios/retrieve-groups#group-properties) | The group that was left |
