...
<Accordion title="Sample Payloads - Initialize CometChat Calls">
<Tabs>
<Tab title="Request">

**Method:** `CometChatCalls.init(callsAppSettings:onSuccess:onError:)`

**CallAppSettings Parameters:**
...
| Property | Type | Value |
|----------|------|-------|
| success | `String` | `"Initialisation Successful"` |
