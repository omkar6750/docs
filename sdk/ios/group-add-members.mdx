...
| `actionOn` | [User](/sdk/ios/users-overview#user-properties) | The user who was added |
| `actionBy` | [User](/sdk/ios/users-overview#user-properties) | The user who added the member |
| `actionFor` | [Group](/sdk/ios/retrieve-groups#group-properties) | The group the member was added to |
