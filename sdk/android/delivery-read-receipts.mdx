...
Use `markMessageAsUnread()` to mark a message as unread. All messages below that message in the conversation will contribute to the unread count. On success, returns an updated `Conversation` object.
...
<AccordionGroup>
  ...
  <Accordion title="Enable Enhanced Messaging Status">
    Enable "Enhanced Messaging Status" in Dashboard for group message receipts and advanced features like `markMessageAsUnread`.
  </Accordion>
</AccordionGroup>
