...
This guide demonstrates how to start a call session in an Android application. Before you begin, we strongly recommend you read the [calling setup guide](/sdk/android/setup-calling).
