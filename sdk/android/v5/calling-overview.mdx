...
1. CometChat SDK installed and configured. See the [Setup](/sdk/android/v5/setup) guide.
...
For detailed setup instructions, see the [Calls SDK Setup](/sdk/android/v5/calling-setup) guide.
...
<CardGroup cols={3}>
  <Card title="Ringing" icon="phone-volume" href="/sdk/android/v5/default-calling">
    Complete calling flow with incoming/outgoing call UI, accept/reject functionality, and call notifications.
  </Card>
  <Card title="Call Session" icon="video" href="/sdk/android/v5/direct-calling">
    Direct call session management. Use with Ringing flow or for custom call initiation logic.
  </Card>
  <Card title="Standalone Calling" icon="phone-flip" href="/sdk/android/v5/standalone-calling">
...
[Get started with Ringing →](/sdk/android/v5/default-calling)
...
[Get started with Call Session →](/sdk/android/v5/direct-calling)
...
[Get started with Standalone Calling →](/sdk/android/v5/standalone-calling)

## Features

<CardGroup cols={2}>
  <Card title="Recording" icon="circle-dot" href="/sdk/android/v5/recording">
  ...
  <Card title="Presenter Mode" icon="presentation-screen" href="/sdk/android/v5/presenter-mode">
    Enable screen sharing and presentation capabilities during calls.
  </Card>
  <Card title="Call Logs" icon="list" href="/sdk/android/v5/call-logs">
    Retrieve and display call history including duration, participants, and status.
  </Card>
  <Card title="Session Timeout" icon="clock" href="/sdk/android/v5/session-timeout">
