...
Once you have decided to implement [Default Calling](/sdk/android/v5/direct-calling) or [Direct Calling](/sdk/android/v5/default-calling) calling and followed the steps to implement them. Just few additional methods will help you quickly customize the main video container.

Please make sure your callSettings is configured accordingly for [Default Calling](/sdk/android/v5/direct-calling) or [Direct Calling](/sdk/android/v5/default-calling).
