...
<CardGroup cols={2}>
  <Card title="User Management" href="/sdk/javascript/user-management">
    Create, update, and manage users
  </Card>
  <Card title="Retrieve Users" href="/sdk/javascript/retrieve-users">
    Fetch user lists with filters and pagination
  </Card>
  <Card title="Connection Status" href="/sdk/javascript/connection-status">
    Monitor SDK connection state changes
  </Card>
  <Card title="All Real-Time Listeners" href="/sdk/javascript/all-real-time-listeners">
