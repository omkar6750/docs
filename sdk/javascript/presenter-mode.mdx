...
This guide demonstrates how to start a presentation in a JavaScript application. Before you begin, we strongly recommend you read the calling setup guide.
...
1. HTML Element - A DOM element in which the calling UI is loaded.
...
In case you wish to achieve a completely customised UI for the Calling experience, you can do so by embedding custom buttons on the page as per your requirement and then use the below methods to achieve different functionalities for the embedded buttons.

For the use case where you wish to align your own custom buttons and not use the default layout provided by CometChat, you can embed the buttons in your page and use the below methods to perform the corresponding operations:
