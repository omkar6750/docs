...
description: "Learn how to change group member scope (admin, moderator, participant) and receive real-time scope change events using the CometChat JavaScript SDK."
---
