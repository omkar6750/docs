...
// Returns: [{ id: "spam", reason: "Spam" }, { id: "harassment", reason: "Harassment" }, ...]

// Flag a message
await CometChat.flagMessage(messageId, {
  reasonId: "spam",  // Required: from getFlagReasons()
  remark: "Optional additional context"
});

// Flagged messages appear in Dashboard > Moderation > Flagged Messages
```
</Info>
