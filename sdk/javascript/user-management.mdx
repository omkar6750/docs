...
<CardGroup cols={2}>
  ...
  <Card title="User Presence" href="/sdk/javascript/user-presence">
    Track real-time online/offline status
  </Card>
  <Card title="Block Users" href="/sdk/javascript/block-users">
    Block and unblock users programmatically
  </Card>
  <Card title="Authentication" href="/sdk/javascript/authentication-overview">
