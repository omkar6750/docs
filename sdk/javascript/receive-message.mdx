...
| Prerequisites | SDK initialized, user logged in, listener registered |
| Related | [Send Message](/sdk/javascript/send-message), [Delivery & Read Receipts](/sdk/javascript/delivery-read-receipts) |
