...
| [UI Kits](/ui-kit/react/overview) | Pre-built components, full control | Low Code |
| **SDK** (this guide) | Complete flexibility, custom UI | Pro Code |
| [REST API](https://api-explorer.cometchat.com) | Server-side integration | Pro Code |
