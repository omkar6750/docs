...
description: "Learn how to change the scope (role) of group members in CometChat using the Flutter SDK, including admin, moderator, and participant roles."
---
...
```dart
// Change member scope (admin, moderator, participant)
await CometChat.updateGroupMemberScope(
  guid: "GROUP_ID",
  uid: "USER_ID",
  scope: CometChatMemberScope.moderator,
...
<CardGroup cols={2}>
  ...
  <Card title="Transfer Ownership" icon="crown" href="/sdk/flutter/transfer-group-ownership">
