...
We recommend before trying this, you refer to the [Message Structure and Hierarchy](/sdk/flutter/v5/messaging-overview#message-structure-and-hierarchy) guide to get familiar with the various categories of messages.
...
We recommend you refer to the [Message Structure and Hierarchy](/sdk/flutter/v5/messaging-overview#message-structure-and-hierarchy) guide to get familiar with the various types of messages before trying this out.
