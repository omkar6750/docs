...
At the minimum, you must add code for [sending messages](/sdk/flutter/v5/send-message) and [receiving messages](/sdk/flutter/v5/receive-messages).

Once you've implemented that, you can proceed to more advanced features like [typing indicators](/sdk/flutter/v5/typing-indicators) and [delivery & read receipts](/sdk/flutter/v5/delivery-read-receipts).
...
See [Interactive Messages](/sdk/flutter/v5/interactive-messages) for more details.
