...
description: "Learn how to retrieve users, fetch user lists with filters, and get user details using the CometChat Flutter SDK."
---
...
Retrieve users allows you to fetch user information including the logged-in user details, lists of users with various filters, and specific user details by UID.
