...
description: "Learn how to register and manage real-time event listeners for messages, users, and groups in the CometChat Flutter SDK."
---
...
CometChat provides real-time event listeners to keep your app updated with live changes. These listeners notify your app when messages are received, users come online/offline, or group membership changes occur.
