...
- **Data mapping**: map payload fields to template variables (see [/notifications/email-templates](/notifications/email-templates) for payload shapes and a SendGrid example).
