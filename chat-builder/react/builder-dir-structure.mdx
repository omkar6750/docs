...
description: "Understand the organization of the CometChat UI Kit Builder directory structure for React, including components, styles, context, and configuration files."
---
...
<Info>
  **Quick Reference for AI Agents & Developers** - **What this page covers**:
  The directory layout of the CometChat UI Kit Builder for React — components,
  styles, context, locales, utils, and configuration files. - **Prerequisites**:
  A working CometChat UI Kit Builder integration (see [Integration
  Guide](/chat-builder/react/integration)). - **Key action**: Use this reference
  to locate files when customizing components, styles, or settings.
</Info>
...
For further customization and integration details:
...
<CardGroup cols={2}>
  ...
  >
    Go beyond settings — modify component props, styling, and behavior.
  </Card>
