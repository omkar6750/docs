...
description: "Learn how to customize CometChat UI Kit Builder components in your Next.js application, including modifying props, styling, and component behavior."
---
...
<Info>
  ...
  **Prerequisites**: A working CometChat UI Kit Builder integration in your
  Next.js app (see [Integration Guide](/chat-builder/nextjs/integration)). -
  **Key action**: Browse the [UI Kit components
