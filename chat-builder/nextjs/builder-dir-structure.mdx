...
description: "Understand the organization of the CometChat UI Kit Builder directory structure for Next.js, including components, styles, context, and configuration files."
---
...
<Info>
  **Quick Reference for AI Agents & Developers** - **What this page covers**:
  The directory layout of the CometChat UI Kit Builder for Next.js — components,
  ...
  Guide](/chat-builder/nextjs/integration)). - **Key action**: Use this
  reference to locate files when customizing components, styles, or settings.
</Info>
