...
<Info>
  **Quick Reference for AI Agents & Developers** - **What this page covers**:
  Complete reference for CometChatSettings configuration options in React Router
  - **Prerequisites**: UI Kit Builder installed via [Integration
  Guide](/chat-builder/react-router/integration) - **Key action**: Configure
  chat features, call features, layout, and styling
</Info>
