...
description: "Understand the organization of the CometChat UI Kit Builder directory structure for React Router, including components, styles, context, and configuration files."
---

<Info>
  **Quick Reference for AI Agents & Developers** - **What this page covers**:
  Complete directory structure breakdown for the CometChat UI Kit Builder in
  React Router projects - **Prerequisites**: UI Kit Builder installed via
  [Integration Guide](/chat-builder/react-router/integration) - **Key action**:
  Navigate and understand the project organization for customization
</Info>
...
<CardGroup cols={2}>
  ...
  >
    Configure CometChatSettings to customize features, layout, and theming.
  </Card>
  <Card
