...
description: "Learn how to customize CometChat UI Kit Builder components in your React Router application, including modifying props, styling, and component behavior."
---
...
<Info>
  ...
  **Prerequisites**: A working CometChat UI Kit Builder integration in your
  React Router app (see [Integration
  Guide](/chat-builder/react-router/integration)). - **Key action**: Browse the
  [UI Kit components overview](/ui-kit/react/components-overview), find the
  component to customize, and update its props or source code.
</Info>
