...
File: `res/drawable/active_send_button.xml` and `res/values/themes.xml`
...
File: `res/drawable/online_indicator_drawable.xml` and `res/values/themes.xml`
...
File: `res/drawable/read_receipts.xml` and `res/values/themes.xml`
...
- [Theme Introduction](/ui-kit/android/theme-introduction)
...
- [AI Features](/ui-kit/android/ai-features)
