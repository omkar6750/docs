...
- [CometChatEmojiKeyboard](/ui-kit/angular/v5/components/emoji-keyboard) - Emoji picker for adding reactions
- [CometChatPopover](/ui-kit/angular/v5/components/cometchat-popover) - Popover component for displaying reaction list
