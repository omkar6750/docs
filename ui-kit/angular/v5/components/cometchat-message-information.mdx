...
- [CometChatAvatar](/ui-kit/angular/v5/components/cometchat-avatar) - Used to display user avatars in receipt items
- [CometChatDate](/ui-kit/angular/v5/components/cometchat-date) - Used to format receipt timestamps
