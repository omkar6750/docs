...
- [CometChatOngoingCall](/ui-kit/angular/v5/components/cometchat-outgoing-call) — Rendered automatically after accepting a call
- [CometChatCallButtons](./cometchat-call-buttons.mdx) — Initiates outgoing calls
- [CometChatListItem](/ui-kit/angular/v5/components/cometchat-user-item) — Used internally to render the caller information
