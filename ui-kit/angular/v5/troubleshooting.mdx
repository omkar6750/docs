...
| **Sample Apps** | [github.com/cometchat/cometchat-sample-app-angular](https://github.com/cometchat/cometchat-uikit-angular/tree/v5/sample-app) | Example implementations |
