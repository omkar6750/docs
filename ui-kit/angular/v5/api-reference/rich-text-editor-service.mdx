...
See [CometChatMessageList — Multiple Message Lists with Different Configurations](/ui-kit/angular/v5/components/cometchat-message-list#multiple-message-lists-with-different-configurations) for a complete multi-panel example.

## See Also

- [MessageComposer Component](/ui-kit/angular/v5/components/cometchat-message-composer)
- [Rich Text Formatting Guide](/ui-kit/angular/v5/guides/custom-text-formatter)
