...
<CardGroup cols={2}>
  <Card title="Message List" href="/ui-kit/angular/v5/components/cometchat-message-list">
    Render real-time message threads.
  </Card>
  <Card title="Thread Header" href="/ui-kit/angular/v5/components/cometchat-thread-header">
