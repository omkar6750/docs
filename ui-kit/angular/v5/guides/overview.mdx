...
| Guides | [Threaded Messages](/ui-kit/angular/v5/guides/threaded-messages) · [Group Chat](/ui-kit/angular/v5/guides/group-chat) · [New Chat](/ui-kit/angular/v5/guides/new-chat) · [Search Messages](/ui-kit/angular/v5/guides/search-messages) · [Block/Unblock](/ui-kit/angular/v5/guides/block-unblock-user) · [Message Privately](/ui-kit/angular/v5/guides/message-privately) · [Call Log Details](/ui-kit/angular/v5/guides/call-log-details) · [Custom Message Types](/ui-kit/angular/v5/guides/custom-message-types) |
...
| [Search Messages](/ui-kit/angular/v5/guides/search-messages) | Add full-text message search across conversations with result routing. |
...
| [Custom Message Types](/ui-kit/angular/v5/guides/custom-message-types) | Register custom message types with bubble templates, conversation subtitle overrides, and fetch inclusion. |
...
| [URL Formatter](/ui-kit/angular/v5/guides/url-formatter) | Detect and style plain URLs as clickable links with optional tracking logic. |
...
| [Rich Text Formatting](/ui-kit/angular/v5/guides/rich-text-formatting) | Configure and customize the rich text editor in the message composer. |
