---
title: "Localize"
description: "Learn how to customize language localization in CometChat UI Kit for React Native to support multiple languages and custom translations."
---
...
<CometChatI18nProvider
  ...
  translations={{
    "en-US": { CHATS: "Welcome to CometChat" },
  }}
>
  {/* Your CometChat components */}
</CometChatI18nProvider>
...
- **Theme Provider** → [Theme](/ui-kit/react-native/theme)
...
<CardGroup cols={2}>
  <Card title="Theme" icon="palette" href="/ui-kit/react-native/theme">
    Customize the visual appearance of UI Kit components
  </Card>
  <Card title="Sound Manager" icon="volume-high" href="/ui-kit/react-native/sound-manager">
    Configure audio cues for chat interactions
  </Card>
</CardGroup>