---
title: "Extensions"
description: "Enhance your React Native chat application with CometChat's built-in extensions including stickers, polls, collaborative whiteboard, document sharing, message translation, and more."
---

<Info>
**Quick Reference for AI Agents & Developers**

Built-in extensions supported by UI Kit:
- **Stickers** → [Sticker Extension](/fundamentals/stickers) - Express emotions with pre-designed stickers
- **Polls** → [Polls Extension](/fundamentals/polls) - Create polls for group discussions
- **Collaborative Whiteboard** → [Whiteboard Extension](/fundamentals/collaborative-whiteboard) - Real-time drawing and brainstorming
- **Collaborative Document** → [Document Extension](/fundamentals/collaborative-document) - Work together on shared documents
- **Message Translation** → [Translation Extension](/fundamentals/message-translation) - Translate messages to local locale
- **Link Preview** → [Link Preview Extension](/fundamentals/link-preview) - URL summaries with thumbnails
- **Thumbnail Generation** → [Thumbnail Extension](/fundamentals/thumbnail-generation) - Auto-generate image previews
</Info>
...
<CardGroup cols={2}>
  <Card title="Message Composer" icon="pen-to-square" href="/ui-kit/react-native/message-composer">
    Compose and send messages with extension features
  </Card>
  <Card title="Message List" icon="list" href="/ui-kit/react-native/message-list">
    Display messages with extension-enhanced content
  </Card>
