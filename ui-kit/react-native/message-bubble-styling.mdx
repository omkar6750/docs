...
description: "Learn how to customize the appearance of incoming and outgoing message bubbles in CometChat React Native UI Kit."
---
    ...
    light: {
      messageListStyles: {
        incomingMessageBubbleStyles: {
          ...
          textBubbleStyles: { containerStyle: { backgroundColor: "#F76808" } },
        },
      },
    },
  }}
...
// Style outgoing message bubbles
<CometChatThemeProvider
  theme={{
    light: {
      messageListStyles: {
        outgoingMessageBubbleStyles: {
          containerStyle: { backgroundColor: "#F76808" },
        },
      },
    },
  }}
...
```js
import {
  // ImageStyle, TextStyle, ViewStyle - types not needed in JavaScript
} from "react-native";

// BubbleStyles object structure (no type annotations in JavaScript)
const bubbleStylesExample = {
  // common bubble Style attributes for all message types
  containerStyle: {},
  ...
  groupCallBubbleStyles: {},
  stickerBubbleStyles: {},
  pollBubbleStyles: {},
  linkPreviewBubbleStyles: {},
};

// UserCallBubbleStyles object structure
const userCallBubbleStylesExample = {
  containerStyle: {},
  textStyle: {},
  iconStyle: {},
};

// CometChatTheme messageListStyles structure
const themeMessageListStylesExample = {
  incomingMessageBubbleStyles: {},
  outgoingMessageBubbleStyles: {},
  groupActionBubbleStyles: {},
  userCallBubbleStyles: {},
};
```
</Tab>
</Tabs>
...
<Frame>
  <img src="/images/4a4f308e-custom_collaborative_bubble-882924e176c97b69879fc4a4db812be4.png" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Theme" icon="palette" href="/ui-kit/react-native/theme">
    Learn about the CometChatThemeProvider and global theming
  </Card>
  <Card title="Component Styling" icon="paintbrush" href="/ui-kit/react-native/component-styling">
    Style individual UI Kit components
  </Card>
</CardGroup>
