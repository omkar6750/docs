...
// Wrap your app with CometChatThemeProvider to enable theming
...
<CometChatThemeProvider theme={{ light: { color: { primary: "#F76808" } } }}>
  {/* Components will use the custom primary color */}
</CometChatThemeProvider>
```

- **Colors** → [Color Resources](/ui-kit/react-native/colors)
