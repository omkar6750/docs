---
title: "Users"
description: "Display and manage user lists with the CometChatUsers component for React Native."
---
...
// With common props
<CometChatUsers
  onItemPress={(user) => handleUserSelect(user)}
  selectionMode="none"
  hideSearch={false}
/>
```
...
CometChatUIEventHandler.addUserListener("USER_LISTENER_ID", {
  ccUserBlocked: ({ item }) => {
    console.log("User blocked:", item);
  },
});

CometChatUIEventHandler.addUserListener("USER_LISTENER_ID", {
  ccUserUnblocked: ({ item }) => {
    console.log("User unblocked:", item);
  },
});
```
</Tab>
...
const getEmptyView = (): JSX.Element => {
  ...
  return <YourCustomEmptyComponent />;
};
...
const getErrorView = (): JSX.Element => {
  ...
  return <YourCustomErrorComponent />;
};
...
const getLeadingView = (user: CometChat.User): JSX.Element => {
  ...
  return <YourCustomLeadingComponent user={user} />;
};
...
const getTitleView = (user: CometChat.User): JSX.Element => {
  ...
  return <YourCustomTitleComponent user={user} />;
};
...
const getTrailingView = (user: CometChat.User): JSX.Element => {
  ...
  return <YourCustomTrailingComponent user={user} />;
};
...
const getItemView = (user: CometChat.User): JSX.Element => {
  ...
  return <YourCustomItemComponent user={user} />;
};
...
const getSubtitleView = (user: CometChat.User): JSX.Element => {
  ...
  return <YourCustomSubtitleComponent user={user} />;
};
