---
title: "Sound Manager"
description: "Learn how to use CometChatSoundManager to play audio cues for incoming and outgoing messages and calls in your React Native chat application."
---
...
<CardGroup cols={2}>
  <Card title="Theme" icon="palette" href="/ui-kit/react-native/theme">
    Customize the overall look and feel of UI Kit components
  </Card>
  <Card title="Localize" icon="globe" href="/ui-kit/react-native/localize">
    Add multi-language support to your chat interface
  </Card>
</CardGroup>
