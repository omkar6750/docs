...
description: "Set up CometChat UI Kit for React Native with step-by-step installation, initialization, and your first conversation."
---
...
```bash
# Install UI Kit and dependencies
...
- **Components Overview** → [Components Overview](/ui-kit/react-native/components-overview)
 ...
 * Props
 * -----
 * • user  – Target user for a 1-to-1 conversation.
 * • group – Target group for a group conversation.
 * • onBack— Callback fired when the back button in the header is pressed.
 *
 */
...
<CardGroup cols={2}>
  <Card title="Core Features" icon="comments" href="/ui-kit/react-native/core-features">
    Explore messaging features like conversations, users, and groups
  </Card>
