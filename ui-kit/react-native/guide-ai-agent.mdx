...
description: "Learn how to integrate AI-powered conversational agents into your React Native app using CometChat UIKit v5."
---

<Info>
**Quick Reference for AI Agents & Developers**

This guide covers integrating AI-powered chat capabilities in React Native:
- Setting up AI Assistant chat screens with `CometChatMessageList`, `CometChatMessageComposer`, and `CometChatMessageHeader`
- Configuring navigation for AI chat flows
- Customizing AI chat themes and styling
- Managing AI chat history with `CometChatAIAssistantChatHistory`

**Related Components:**
- [AI Assistant Chat History](/ui-kit/react-native/ai-assistant-chat-history) - Display previous AI conversations
- [Message List](/ui-kit/react-native/message-list) - Core message display component
- [Message Composer](/ui-kit/react-native/message-composer) - Input interface for messages
- [Message Header](/ui-kit/react-native/message-header) - Header with user info and controls
</Info>
...
<CardGroup cols={2}>
  <Card title="AI Assistant Chat History" icon="clock-rotate-left" href="/ui-kit/react-native/ai-assistant-chat-history">
    Display and manage previous AI conversation history
  </Card>
  <Card title="Message List" icon="list" href="/ui-kit/react-native/message-list">
    Learn more about the core message display component
  </Card>
</CardGroup>