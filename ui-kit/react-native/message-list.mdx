  ...
  "props": {
    "data": {
      ...
      "addTemplates": {
        "type": "CometChatMessageTemplate[]",
        "default": "[]",
        "note": "Additional message templates to append to defaults"
      },
      "parentMessageId": {
        "type": "number",
        "default": "undefined",
      ...
      "goToMessageId": {
        "type": "string",
        "default": "undefined",
        "note": "Message ID to navigate to and highlight"
      },
      "searchKeyword": {
        "type": "string",
        "default": "undefined",
        "note": "Keyword to highlight in message text"
      }
    },
    "callbacks": {
...
| `hideReactionOption` | Hide reaction option | `hideReactionOption={true}` |
...
| `hideReplyOption` | Hide reply option | `hideReplyOption={true}` |
| `hideFlagMessageOption` | Hide flag message option | `hideFlagMessageOption={true}` |
| `hideFlagRemarkField` | Hide flag remark field | `hideFlagRemarkField={true}` |
