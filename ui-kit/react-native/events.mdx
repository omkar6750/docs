---
title: "Events"
description: "Subscribe to UI Kit events to respond to user interactions and state changes in your React Native application."
---
...
const conversationListenerId = "UNIQUE_LISTENER_ID";
...
const messageListenerId = "MESSAGE_LISTENER_ID";
CometChatUIEventHandler.addMessageListener(messageListenerId, {
  ccMessageSent: (message: CometChat.BaseMessage, status: string) => {
...
<CardGroup cols={2}>
  <Card title="Methods" icon="code" href="/ui-kit/react-native/methods">
    Explore initialization, login, and logout methods
  </Card>
