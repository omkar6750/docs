---
title: "Conversations"
description: "Display and manage conversation lists with the CometChatConversations component for React Native."
---
...
// With common props
<CometChatConversations
  onItemPress={(conversation) => handleConversationSelect(conversation)}
...
const onPressHandler = (conversationClicked: CometChat.Conversation) => {
  console.log("Selected:", conversationClicked);
};
...
const onPressHandler = (conversationClicked) => {
  console.log("Selected:", conversationClicked);
};
...
const onLongPressHandler = (conversationClicked: CometChat.Conversation) => {
  console.log("Long pressed:", conversationClicked);
};
...
const onLongPressHandler = (conversationClicked) => {
  console.log("Long pressed:", conversationClicked);
};
...
const onSelectionHandler = (selection: Array<CometChat.Conversation>) => {
  console.log("Selected conversations:", selection);
};
...
To remove the listener, use the following code:
...
const getLeadingView = (conversation) => {
  // Your custom Leading View
  // return jsx;
};
...
const getTitleView = (conversation) => {
  // Your custom Title View
  // return jsx;
};
...
const getTrailingView = (conversation) => {
  // Your custom Trailing View
  // return jsx;
};
...
const getItemView = (conversation) => {
  // Your custom Item View
  // return jsx;
};
      ...
      <View style={{ flexDirection: "row" }}>
        ...
        {conversationWith instanceof CometChat.User && (
          <CometChatStatusIndicator
            ...
            type={conversationWith.getStatus()}
          />
        )}
      </View>
      <Text
...
const getDateView = (conversation) => {
  const timestamp = conversation.getLastMessage()?.getSentAt();
  return (
    <CometChatDate
      timeStamp={timestamp * 1000}
...
const getTextFormatters = (): CometChatTextFormatter[] => {
...
const generateDateString = (conversation: CometChat.Conversation): string => {
...
const generateDateString = (conversation) => {
...
<Tab title="TypeScript">
```tsx
import { CometChatConversations, useTheme } from "@cometchat/chat-uikit-react-native";
import { CometChat } from "@cometchat/chat-sdk-react-native";
...
const setMyOptions = (conversation) => {
  return [
    // Options
  ];
};
