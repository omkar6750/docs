...
description: "Display conversation history between users and an AI assistant with the CometChatAIAssistantChatHistory component for React Native."
---
...
const user = new CometChat.User({ uid: "userId", name: "User Name", role: "@agentic" });
...
<CometChatAIAssistantChatHistory
  user={user}
  onClose={() => handleClose()}
  onMessageClicked={(message) => handleMessageClick(message)}
  onNewChatButtonClick={() => handleNewChat()}
...
<CardGroup cols={2}>
  <Card title="Extensions" icon="puzzle-piece" href="/ui-kit/react-native/extensions">
    Explore AI and extension features
  </Card>
  ...
  <Card title="Conversations" icon="comments" href="/ui-kit/react-native/conversations">
    Browse and manage conversation lists
  </Card>
</CardGroup>
