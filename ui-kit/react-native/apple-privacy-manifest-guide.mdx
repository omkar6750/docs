...
description: "Learn how to configure Apple's Privacy Manifest for React Native UI Kit apps to comply with App Store privacy requirements."
---

<Info>
**Quick Reference for AI Agents & Developers**

This guide covers Apple Privacy Manifest configuration for React Native UI Kit:
- Privacy manifest file structure (`PrivacyInfo.xcprivacy`)
- Required API declarations for React Native and SPTPersistentCache
- Step-by-step Xcode setup instructions

Related: [Getting Started](/ui-kit/react-native/getting-started) | [Overview](/ui-kit/react-native/overview)
</Info>
...
<CardGroup cols={2}>
  <Card title="Getting Started" icon="rocket" href="/ui-kit/react-native/getting-started">
    Set up CometChat React Native UI Kit in your app
  </Card>
  <Card title="Overview" icon="book" href="/ui-kit/react-native/overview">
    Learn about React Native UI Kit features and architecture
  </Card>
</CardGroup>
