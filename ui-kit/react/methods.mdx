---
title: "Methods"
description: "CometChatUIKit class methods — init, login, logout, create user, and send messages"
---
...
// Login
CometChatUIKit.login("UID");                    // with Auth Key
CometChatUIKit.loginWithAuthToken("AUTH_TOKEN"); // production
