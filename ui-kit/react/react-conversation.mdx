...
description: "Build a two-panel conversation list and message view layout in React.js using CometChat UI Kit"
---
...
```tsx
import { CometChatConversations, CometChatMessages } from "@cometchat/chat-uikit-react";

// Two-panel layout: Conversations sidebar + Message view
<CometChatConversations onItemClick={(conversation) => setActiveChat(conversation)} />
<CometChatMessages user={selectedUser} group={selectedGroup} />
```
</Info>
