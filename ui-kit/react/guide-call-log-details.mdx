...
description: "Learn how to display comprehensive call information and history when users select calls from the calls tab in your React chat app."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Call Buttons" icon="phone-volume" href="/ui-kit/react/call-buttons">
