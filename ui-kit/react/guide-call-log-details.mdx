...
description: "Build a detailed call insights screen with metadata, participants, and recordings using CometChat React UI Kit"
---
...
// Call log details: metadata, participants, join/leave history, recordings
// Uses CometChatCallLogs component with detail view
```
</Info>
...
<CardGroup cols={2}>
  <Card title="Call Logs Component" icon="phone" href="/ui-kit/react/call-logs">
    Explore the Call Logs UI component
  </Card>
