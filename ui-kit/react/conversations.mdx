---
title: "Conversations"
description: "Display and manage the conversation list — recent chats, unread counts, presence, and custom views"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Search" icon="magnifying-glass" href="/ui-kit/react/search">
