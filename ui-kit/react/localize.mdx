...
description: "Configure multi-language localization to adapt UI elements based on user's preferred language settings."
---
...
const text = CometChatLocalize.getLocalizedString("welcome_message");
