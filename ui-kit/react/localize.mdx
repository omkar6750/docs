...
description: "Multi-language localization, date/time formatting, and custom translations for the React UI Kit"
---
...
CometChatLocalize.addTranslation({ "en-US": { "welcome_message": "Welcome!" } });

// Custom date format (global)
CometChatLocalize.init({
  calendarObject: new CalendarObject({ today: "hh:mm A", yesterday: "[Yesterday]", otherDays: "DD MMM YYYY" })
});
```

Supported: 19 languages including en-US, es, fr, de, hi, ja, ko, zh, and more.
</Info>
...
<CardGroup cols={2}>
  <Card title="Theming" icon="palette" href="/ui-kit/react/theme">
    Customize colors, fonts, and dark/light mode
  </Card>
  <Card title="Sound Manager" icon="volume-high" href="/ui-kit/react/sound-manager">
    Manage audio cues for calls and messages
  </Card>
</CardGroup>