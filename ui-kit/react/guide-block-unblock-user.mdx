...
description: "Learn how to implement user blocking functionality to prevent unwanted communication in your React chat app."
---
...
// Unblock a user
CometChat.unblockUsers([userId]).then(() => {
  user.setBlockedByMe(false);
  CometChatUserEvents.ccUserUnblocked.next(user);
});

// Check if user is blocked
const isBlocked = user.getBlockedByMe();
```
</Info>
