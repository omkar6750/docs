...
description: "Implement user blocking and unblocking functionality in your React chat app using CometChat UI Kit"
---
...
CometChatUserEvents.ccUserBlocked.subscribe(...)
CometChatUserEvents.ccUserUnblocked.subscribe(...)
```
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Users Component" icon="user" href="/ui-kit/react/users">
    Explore the Users component for user management
  </Card>
  <Card title="Group Management" icon="users" href="/ui-kit/react/guide-group-chat">
    Manage groups, members, roles, and ownership
  </Card>
