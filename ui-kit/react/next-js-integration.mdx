...
description: "Step-by-step guide to install, initialize, and integrate CometChat React UI Kit in your Next.js project with SSR support"
---
...
# Key: Use "use client" directive for CometChat components in Next.js
# CometChat requires browser APIs (window, WebSocket, document)
```
...
<CardGroup cols={2}>
  <Card title="Conversation List + Message" icon="comments" href="/ui-kit/react/next-conversation">
