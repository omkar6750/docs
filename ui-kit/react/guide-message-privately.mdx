...
description: "Launch a direct 1:1 chat from a user profile or list with optional first message"
---
...
```tsx
// Launch private chat by selecting a user from a list or profile
// Optionally send a first message to surface the conversation
// Uses CometChatMessages with a target user prop
```
</Info>
...
<CardGroup cols={2}>
  <Card title="New Chat" icon="plus" href="/ui-kit/react/guide-new-chat">
    Unified entry for starting new 1:1 or group chats
  </Card>
  <Card title="Block/Unblock Users" icon="ban" href="/ui-kit/react/guide-block-unblock-user">
    Add user blocking functionality
  </Card>
  <Card title="Users Component" icon="user" href="/ui-kit/react/users">
    Explore the Users component
  </Card>
