...
- Your app will support initiating private messages from group contexts, allowing users to smoothly switch between group discussions and private conversations.  
