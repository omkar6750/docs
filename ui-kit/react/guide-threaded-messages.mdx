...
description: "Learn how to enable organized threaded conversations within group chats using CometChat's React UI Kit."
---
...
// Enable thread replies in messages
<CometChatMessages
  group={group}
...
<CometChatThreadedMessages
  ...
  onClose={() => setThreadedMessage(undefined)}
/>
```
</Info>
