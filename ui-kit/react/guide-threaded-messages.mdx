...
description: "Implement organized threaded conversations within group chats using CometChat React UI Kit"
---
...
// Key components: CometChatThreadedMessages, CometChatThreadHeader
// Trigger: CometChatMessages.onThreadRepliesClick
// Filter: CometChatMessageList with parentMessageId
```
</Info>
...
<CardGroup cols={2}>
  <Card title="Thread Header" icon="message" href="/ui-kit/react/thread-header">
    Customize the thread header component
  </Card>
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">
    Explore message list customization options
  </Card>
  <Card title="Search Messages" icon="magnifying-glass" href="/ui-kit/react/guide-search-messages">
    Add full-text message search across conversations
  </Card>
