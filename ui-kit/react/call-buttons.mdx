---
title: "Call Buttons"
description: "Audio and video call trigger buttons for user and group chats"
---
...
<CardGroup cols={2}>
  <Card title="Incoming Call" icon="phone-arrow-down-left" href="/ui-kit/react/incoming-call">
    Handle incoming audio and video calls with accept/reject UI.
  </Card>
  <Card title="Outgoing Call" icon="phone-arrow-up-right" href="/ui-kit/react/outgoing-call">
    Display outgoing call status and transition to active call screen.
  </Card>
</CardGroup>
