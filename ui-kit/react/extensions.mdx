---
title: "Extensions"
description: "Built-in extensions — stickers, polls, collaborative documents, whiteboards, and more"
---
...
- [Stickers](/fundamentals/stickers) — Fun sticker packs in the composer
- [Polls](/fundamentals/polls) — Create polls in group chats
- [Collaborative Whiteboard](/fundamentals/collaborative-whiteboard) — Real-time shared drawing
- [Collaborative Document](/fundamentals/collaborative-document) — Shared document editing
- [Message Translation](/fundamentals/message-translation) — Translate messages on the fly
- [Link Preview](/fundamentals/link-preview) — Rich URL previews in messages
- [Thumbnail Generation](/fundamentals/thumbnail-generation) — Auto-generated image thumbnails
</Info>
...
<CardGroup cols={2}>
  <Card title="Core Features" icon="comments" href="/ui-kit/react/core-features">
    Explore the core chat features available in the UI Kit.
  </Card>
  <Card title="AI Features" icon="robot" href="/ui-kit/react/ai-features">
    Explore all AI-powered features available in the UI Kit.
  </Card>
</CardGroup>
