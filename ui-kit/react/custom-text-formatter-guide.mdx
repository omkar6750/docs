...
description: "Create custom text formatters for CometChat using CometChatTextFormatter to implement inline patterns like hashtags and keywords"
---
...
// Extend CometChatTextFormatter for custom formatting
...
// Apply to components
<CometChatMessageList textFormatters={[new HashTagTextFormatter()]} />
```
</Info>
