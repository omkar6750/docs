...
description: "Guide to creating custom text formatters for CometChat using CometChatTextFormatter for message composer and text bubbles."
---
...
// Extend to create custom formatter
