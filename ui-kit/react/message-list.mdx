---
title: "Message List"
description: "A component that displays messages in a conversation with real-time updates, reactions, threads, and customization options."
---
...
<Tabs>
<Tab title="MessageListDemo (TypeScript)">
```tsx
...
<Tab title="MessageListDemo (JavaScript)">
```jsx
import React from "react";
import { CometChat } from "@cometchat/chat-sdk-javascript";
import { CometChatMessageList } from "@cometchat/chat-uikit-react";
