---
title: "Message List"
description: "Render messages with real-time updates — text, media, reactions, threads, and custom message bubbles"
---
...
// With common props
<CometChatMessageList user={chatUser} hideReceipts={false} scrollToBottomOnNewMessages={true} />
```
</Info>
...
<Note>
**Available via:** [UI Kits](/ui-kit/react/overview) | [SDK](/sdk/javascript/receive-message)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Message Template" href="/ui-kit/react/message-template" icon="file-code" />
