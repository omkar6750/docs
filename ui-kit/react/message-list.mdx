...
| `goToMessageId` | `number` | `undefined` | Scrolls to the specified message on initial load | — |
...
| `hideConversationStarters` | `boolean` | `false` | Hides AI conversation starters | — |
| `hideSmartReplies` | `boolean` | `false` | Hides AI smart replies | — |
