---
title: "Groups"
description: "A component that displays a searchable list of all available groups with member counts and group icons."
---
...
<Tabs>
<Tab title="GroupsDemo (TypeScript/JavaScript)">
```tsx
import { CometChatGroups } from "@cometchat/chat-uikit-react";
