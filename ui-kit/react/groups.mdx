---
title: "Groups"
description: "Display and manage group lists with search, selection, and custom views"
---
...
<CometChatGroups onItemClick={(group) => console.log("Selected:", group)} />
```
</Info>
...
<Note>
**Available via:** [UI Kits](/ui-kit/react/overview) | [SDK](/sdk/javascript/retrieve-groups) | [REST API](https://api-explorer.cometchat.com)
</Note>
