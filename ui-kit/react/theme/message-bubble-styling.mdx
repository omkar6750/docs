...
description: "Customize incoming and outgoing message bubble styles for text, image, video, audio, file, and extension messages using CSS variables"
---
...
Supported bubble types: text, image, video, audio, file, delete, action, direct call, whiteboard, document, poll, sticker, link preview
</Info>
...
<CardGroup cols={2}>
  <Card title="Color Resources" icon="swatchbook" href="/ui-kit/react/theme/color-resources">
    Complete color palette reference for light and dark modes
  </Card>
  ...
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">
    Customize the message list component
  </Card>
