---
title: "Events"
description: "Reference for CometChat UI Kit events including conversation, user, group, message, and call events."
---
...
// Subscribe to events
const subscription = CometChatMessageEvents.ccMessageSent.subscribe(
...
- **CometChatConversationEvents** → Conversation actions
- **CometChatUserEvents** → User block/unblock
- **CometChatGroupEvents** → Group management
- **CometChatMessageEvents** → Message lifecycle
- **CometChatCallEvents** → Call lifecycle
</Info>
...
<CardGroup cols={2}>
  <Card title="Methods" icon="code" href="/ui-kit/react/methods">
    UI Kit initialization and login methods
  </Card>
