---
title: "Events"
description: "Complete reference of all events emitted by CometChat UI Kit components"
---
...
// CometChatGroupEvents — group CRUD, member changes
// CometChatMessageEvents — message sent/edited/deleted, typing, receipts
// CometChatCallEvents — call initiated/accepted/rejected/ended
// CometChatUIEvents — active chat changed
```
</Info>
...
<CardGroup cols={2}>
  <Card title="Methods" icon="code" href="/ui-kit/react/methods">
    Init, login, logout, and message-sending wrapper methods
  </Card>
  <Card title="Components Overview" icon="puzzle-piece" href="/ui-kit/react/components-overview">
    Understand Actions, Events, and component architecture
  </Card>
</CardGroup>
