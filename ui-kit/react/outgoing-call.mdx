---
title: "Outgoing Call"
description: "Display outgoing call status and transition to active call screen"
---
...
<CometChatOutgoingCall call={callObject} />
```
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Call Logs" icon="clock-rotate-left" href="/ui-kit/react/call-logs">
    Display call history with details, participants, and recordings.
  </Card>
</CardGroup>
