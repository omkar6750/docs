...
<Note>
CometChat UI Kit requires browser APIs (`window`, `WebSocket`, `document`). For Next.js or other SSR frameworks, render components only on the client side. See the [Next.js Integration](/ui-kit/react/next-js-integration) guide.
</Note>
