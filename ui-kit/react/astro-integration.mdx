...
description: "Step-by-step guide to install, initialize, and integrate CometChat React UI Kit in your Astro project"
---
...
<CardGroup cols={2}>
  <Card title="Conversation List + Message" icon="comments" href="/ui-kit/react/astro-conversation">
    Build a two-panel chat layout with sidebar and message view
  </Card>
  <Card title="One-to-One Chat" icon="message" href="/ui-kit/react/astro-one-to-one-chat">
    Integrate a focused direct messaging experience
  </Card>
  <Card title="Tab-Based Chat" icon="table-columns" href="/ui-kit/react/astro-tab-based-chat">
    Create a multi-tab UI with chats, calls, users, and groups
  </Card>
