---
title: "Users"
description: "Display and manage user lists with search, selection, and custom views"
---
...
<CometChatUsers onItemClick={(user) => console.log("Selected:", user)} />
```
</Info>
...
<Note>
**Available via:** [UI Kits](/ui-kit/react/overview) | [SDK](/sdk/javascript/retrieve-users) | [REST API](https://api-explorer.cometchat.com)
</Note>
