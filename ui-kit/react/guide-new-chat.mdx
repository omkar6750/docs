...
description: "Implement a unified entry point for starting new 1:1 or group chats with user and group discovery"
---
...
```tsx
import { CometChatUsers, CometChatGroups, CometChatConversations } from "@cometchat/chat-uikit-react";

// New chat flow: User/Group selection → Open message view
// Use CometChatUsers for 1:1 chat discovery
// Use CometChatGroups for group chat discovery
```
</Info>
...
<CardGroup cols={2}>
  <Card title="Conversations" icon="comments" href="/ui-kit/react/conversations">
    Display and manage the conversation list
  </Card>
  <Card title="Message Privately" icon="lock" href="/ui-kit/react/guide-message-privately">
    Launch direct 1:1 chats from user profiles
  </Card>
  <Card title="Group Management" icon="users" href="/ui-kit/react/guide-group-chat">
