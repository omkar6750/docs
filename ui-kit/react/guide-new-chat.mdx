...
description: "Learn how to enable users to create new conversations with individual users or join existing groups in your React chat app."
---
...
// Group selection for new chat
<CometChatGroups
  groupsRequestBuilder={new CometChat.GroupsRequestBuilder().joinedOnly(true)}
