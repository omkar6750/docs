---
title: "Search"
description: "Search across conversations and messages with filters, scopes, and custom result views"
---
...
<CometChatSearch />
<CometChatSearch onConversationClicked={(conv) => openChat(conv)} onMessageClicked={(msg) => goToMessage(msg)} />
```
</Info>
