...
<div className="tab-based-chat">
  {/* Tab Navigation */}
  <CometChatTabs activeTab={activeTab} onTabClicked={setActiveTab} />
  
  {/* Sidebar based on active tab */}
  {activeTab === "chats" && <CometChatConversations onItemClick={handleSelect} />}
  {activeTab === "calls" && <CometChatCallLogs onItemClick={handleSelect} />}
  {activeTab === "users" && <CometChatUsers onItemClick={handleSelect} />}
  {activeTab === "groups" && <CometChatGroups onItemClick={handleSelect} />}
