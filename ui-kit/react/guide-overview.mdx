...
- **Block/Unblock User** → [Guide](/ui-kit/react/guide-block-unblock-user)
- **New Chat** → [Guide](/ui-kit/react/guide-new-chat)
- **Message Privately** → [Guide](/ui-kit/react/guide-message-privately)
...
<CardGroup cols={2}>
  <Card title="Threaded Messages" icon="comments" href="/ui-kit/react/guide-threaded-messages">
    Implement organized threaded conversations in group chats
  </Card>
  <Card title="Block/Unblock Users" icon="ban" href="/ui-kit/react/guide-block-unblock-user">
    Add user blocking functionality for privacy control
  </Card>
