...
description: "Add full-text message search across conversations with result routing using CometChat React UI Kit"
---
...
// Search messages using MessagesRequestBuilder
new CometChat.MessagesRequestBuilder()
  .setSearchKeyword("search term")
  .setLimit(50)
  .build();
```
</Info>
...
<CardGroup cols={2}>
  <Card title="Search Component" icon="magnifying-glass" href="/ui-kit/react/search">
    Explore the Search UI component
  </Card>
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">
    Customize the message list display
  </Card>
