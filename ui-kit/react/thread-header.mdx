---
title: "Thread Header"
description: "Display parent message context and reply count for threaded conversations"
---
...
<Note>
Available via: [UI Kits](/ui-kit/react/overview) | [SDK](/sdk/javascript/threaded-messages)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Message Header" icon="heading" href="/ui-kit/react/message-header">
    Display conversation context at the top of the chat view.
  </Card>
</CardGroup>
