...
description: "Display user/group info, typing indicators, and call buttons in the chat header"
---
...
<CometChatMessageHeader onItemClick={getOnItemClick} />;
```
...
<CardGroup cols={2}>
  ...
  <Card title="Thread Header" href="/ui-kit/react/thread-header" icon="code-branch" />
</CardGroup>
