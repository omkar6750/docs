...
description: "AI-powered conversation starters, smart replies, and conversation summaries in the React UI Kit"
---
...
AI features are auto-enabled via Dashboard — no extra code needed:
- **Conversation Starters** → auto-appears in [Message List](/ui-kit/react/message-list) for new chats
- **Smart Replies** → auto-appears in [Message Composer](/ui-kit/react/message-composer) action sheet
- **Conversation Summary** → auto-appears in [Message Composer](/ui-kit/react/message-composer) action sheet

Enable each feature in the [CometChat Dashboard](https://app.cometchat.com/) under AI settings.
</Info>
...
<CardGroup cols={2}>
  <Card title="AI Assistant Chat" icon="robot" href="/ui-kit/react/ai-assistant-chat">
    Full AI agent chat component with streaming and tools
  </Card>
