...
description: "Implement !shortcut style text expansions using extension APIs or dialogs in CometChat React UI Kit"
---
...
// ShortCutFormatter extends CometChatTextFormatter
// Tracks "!" character for shortcut expansions
// Fetches shortcuts from CometChat message-shortcuts extension
