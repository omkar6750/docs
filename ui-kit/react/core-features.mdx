---
title: "Core"
description: "How UI Kit components work together to deliver messaging, media sharing, receipts, typing indicators, reactions, mentions, and more"
---
...
- **[Conversations](/ui-kit/react/conversations)** — conversation list with last message, unread count, presence
- **[Message List](/ui-kit/react/message-list)** — renders all message types with real-time updates
- **[Message Composer](/ui-kit/react/message-composer)** — text input, media attachments, mentions, reactions
- **[Message Header](/ui-kit/react/message-header)** — user/group info, typing indicator, call buttons
- **[Search](/ui-kit/react/search)** — full-text search across conversations and messages
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="AI Features" icon="robot" href="/ui-kit/react/ai-features">
    Smart replies, conversation starters, and summaries
  </Card>
  <Card title="Extensions" icon="plug" href="/ui-kit/react/extensions">
    Stickers, polls, collaborative tools, and more
  </Card>
</CardGroup>
