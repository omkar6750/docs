...
description: "Create and manage groups, view members, assign roles, and transfer ownership using CometChat React UI Kit"
---
...
```tsx
import { CometChatGroups, CometChatGroupMembers } from "@cometchat/chat-uikit-react";

// Group management: create/join groups, manage members, roles, ownership
// Uses CometChatGroups + CometChatGroupMembers components
```
</Info>
...
<CardGroup cols={2}>
  <Card title="Groups Component" icon="users" href="/ui-kit/react/groups">
    Explore the Groups UI component
  </Card>
  <Card title="Group Members" icon="user-group" href="/ui-kit/react/group-members">
    Manage group member lists and roles
  </Card>
  <Card title="New Chat" icon="plus" href="/ui-kit/react/guide-new-chat">
    Start new 1:1 or group conversations
  </Card>
