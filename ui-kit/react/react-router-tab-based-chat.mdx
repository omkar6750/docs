...
description: "Build a tab-based messaging UI with chats, calls, users, and groups with React Router using CometChat UI Kit"
---
...
<CardGroup cols={2}>
  <Card title="Conversation List + Message" icon="comments" href="/ui-kit/react/react-router-conversation">
