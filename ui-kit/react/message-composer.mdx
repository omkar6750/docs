...
description: "A component that enables users to write and send text, media, and custom messages with attachments and editing support."
---
...
<CometChatMessageComposer
  ...
  onSendButtonClick={(message) => handleSend(message)}
/>
```
</Info>
