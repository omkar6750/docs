...
description: "Text input, media attachments, mentions, reactions, and custom actions for composing messages"
---
...
<Note>
**Available via:** [UI Kits](/ui-kit/react/overview) | [SDK](/sdk/javascript/send-message)
</Note>
