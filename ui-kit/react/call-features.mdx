---
title: "Call"
description: "Audio and video calling components — incoming calls, outgoing calls, call buttons, and call logs"
---
...
```bash
# Required: install Calls SDK separately
npm install @cometchat/calls-sdk-javascript
```

Call components:
- **[Incoming Call](/ui-kit/react/incoming-call)** — receive and accept/reject calls
- **[Outgoing Call](/ui-kit/react/outgoing-call)** — initiate calls with status display
- **[Call Buttons](/ui-kit/react/call-buttons)** — audio/video call trigger buttons
- **[Call Logs](/ui-kit/react/call-logs)** — call history with details
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Core Features" icon="comments" href="/ui-kit/react/core-features">
    Messaging, receipts, typing indicators, and more
  </Card>
</CardGroup>
