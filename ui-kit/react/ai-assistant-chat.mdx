...
description: "AI agent chat component with streaming responses, tool calls, and chat history"
---
...
<CometChatAIAssistantChat user={agentUser} />
// With custom suggestions
<CometChatAIAssistantChat user={agentUser} suggestedMessages={["Help", "Summarize"]} />
```
</Info>
