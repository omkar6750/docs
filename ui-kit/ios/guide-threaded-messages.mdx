...
description: "Guide to adding threaded reply views in your iOS app using CometChat UI Kit with CometChatThreadedMessages component."
---
...
- **Key component:** `CometChatThreadedMessages`
- **Import:** `import CometChatUIKitSwift`
- **Usage:** `let threaded = CometChatThreadedMessages()` → `threaded.set(parentMessage:)` → push
- **Related:** [Threaded Messages Header](/ui-kit/ios/threaded-messages-header) · [Message List](/ui-kit/ios/message-list) · [Guide Overview](/ui-kit/ios/guide-overview)
</Info>
