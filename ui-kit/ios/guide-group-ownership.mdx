...
description: "Guide to implementing group ownership transfer in your iOS app using CometChat UI Kit with CometChatGroupMembers and transfer ownership components."
---
...
- **Key components:** `CometChatGroupMembers`, `TransferOwnership`
- **SDK method:** `CometChat.transferGroupOwnership()`
- **Import:** `import CometChatUIKitSwift`
- **Related:** [Groups](/ui-kit/ios/groups) · [Group Members](/ui-kit/ios/group-members) · [Guide Overview](/ui-kit/ios/guide-overview)
</Info>
