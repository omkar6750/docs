...
<Note>
By default, all mobile UI Kits inherit font size from the operating system's accessibility settings. However, on iOS, developers have the option to override this behavior and set custom font sizes programmatically using the styling properties shown below.
</Note>
