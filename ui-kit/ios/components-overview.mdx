---
title: "Overview"
description: "Overview of CometChat iOS UI Kit component types, actions, events, and configurations."
---
...
- **Call Buttons** → [CometChatCallButtons](/ui-kit/ios/call-buttons)
...
<CardGroup cols={2}>
  ...
  <Card title="Message List" icon="message" href="/ui-kit/ios/message-list">
    Render chat messages with real-time updates
  </Card>
  <Card title="Core Features" icon="star" href="/ui-kit/ios/core-features">
    Overview of all core chat features
  </Card>
