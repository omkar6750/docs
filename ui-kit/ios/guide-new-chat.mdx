...
description: "Guide to building a new conversation screen in your iOS app using CometChat UI Kit with user and group discovery components."
---
...
- **Key components:** `CometChatUsers`, `CometChatGroups`, `CreateConversationVC`
- **Import:** `import CometChatUIKitSwift`
- **Related:** [Users](/ui-kit/ios/users) · [Groups](/ui-kit/ios/groups) · [Conversations](/ui-kit/ios/conversations) · [Guide Overview](/ui-kit/ios/guide-overview)
</Info>
