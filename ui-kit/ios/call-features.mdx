---
title: "Call"
description: "Integrate audio and video calling features into your iOS app using CometChat UI Kit call components."
---
...
Key components for calling features:
- **Call Buttons** → [CometChatCallButtons](/ui-kit/ios/call-buttons) (renders in MessageHeader)
- **Incoming Call** → [CometChatIncomingCall](/ui-kit/ios/incoming-call)
- **Outgoing Call** → [CometChatOutgoingCall](/ui-kit/ios/outgoing-call)
- **Call Logs** → [CometChatCallLogs](/ui-kit/ios/call-logs)

**Requires:** `CometChatCallsSDK` — install separately via CocoaPods or SPM.
</Info>
...
<Note>
**Available via:** [UI Kits](/ui-kit/ios/overview) | [SDK](/sdk/ios/overview)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Incoming Call" icon="phone-arrow-down-left" href="/ui-kit/ios/incoming-call">
    Handle incoming call screens and notifications
  </Card>
  <Card title="Call Logs" icon="clock-rotate-left" href="/ui-kit/ios/call-logs">
    Display call history and call details
  </Card>
