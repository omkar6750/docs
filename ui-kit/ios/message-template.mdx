...
description: "Reference for CometChat iOS UI Kit MessageTemplate that defines the structure and behavior of message bubbles including header, content, footer, and bottom views."
---
...
- **Key properties:** `type`, `category`, `contentView`, `headerView`, `footerView`, `bottomView`, `options`
- **Get defaults:** `CometChatUIKit.getDataSource().getAllMessageTemplates()`
- **Related:** [MessageList](/ui-kit/ios/message-list) · [Message Bubble Styling](/ui-kit/ios/message-bubble-styling) · [MessageComposer](/ui-kit/ios/message-composer)
</Info>
