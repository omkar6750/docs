---
title: "Events"
description: "Reference for CometChat iOS UI Kit events including user, conversation, message, group, and call events that enable decoupled component communication."
---
...
- **Event classes:** `CometChatUserEvents`, `CometChatConversationEvents`, `CometChatMessageEvents`, `CometChatGroupEvents`, `CometChatCallEvents`
- **Import:** `import CometChatUIKitSwift`
- **Add listener:** `CometChat[Type]Events.addListener("UNIQUE_ID", self as CometChat[Type]EventListener)`
- **Remove listener:** `CometChat[Type]Events.removeListener("UNIQUE_ID")`
- **Related:** [Methods](/ui-kit/ios/methods) · [Components Overview](/ui-kit/ios/components-overview) · [SDK Overview](/sdk/ios/overview)
</Info>
...
<CardGroup cols={2}>
  <Card title="Methods" icon="terminal" href="/ui-kit/ios/methods">
    CometChatUIKit wrapper methods reference
  </Card>
