---
title: "Extensions"
description: "Built-in extensions for the CometChat iOS UI Kit including stickers, polls, reactions, translation, and more."
---
...
Extensions are enabled via the [CometChat Dashboard](https://app.cometchat.com) and automatically integrate into UI Kit components. No extra code needed.

Key extensions:
- **Stickers** → [Message Composer](/ui-kit/ios/message-composer)
- **Polls** → [Message Composer](/ui-kit/ios/message-composer) action sheet
- **Reactions** → [Message List](/ui-kit/ios/message-list) action sheet
- **Message Translation** → [Message List](/ui-kit/ios/message-list) action sheet
- **Link Preview** → [Message List](/ui-kit/ios/message-list) message bubble
- **Collaborative Whiteboard/Document** → [Message Composer](/ui-kit/ios/message-composer) action sheet
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="AI Features" icon="robot" href="/ui-kit/ios/ai-features">
    AI-powered conversation starters, smart replies, and summaries
  </Card>
  <Card title="Call Features" icon="phone" href="/ui-kit/ios/call-features">
