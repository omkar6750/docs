...
description: "Guide to building a group details screen in your iOS app using CometChat UI Kit with CometChatGroupMembers and group management components."
---
...
- **Key components:** `CometChatGroupMembers`, `GroupDetailsViewController`
