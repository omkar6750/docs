...
```json
{
  ...
  "props": {
    ...
    "callbacks": {
      "onItemClick": "(CallLog, IndexPath) -> Void",
      "onItemLongClick": "(CallLog, IndexPath) -> Void",
      "onBack": "() -> Void",
      "onError": "(CometChatCallException) -> Void",
      "onEmpty": "() -> Void",
      "onLoad": "([CallLog]) -> Void"
    },
    "visibility": {
    ...
    "viewSlots": {
      "listItemView": "(CallLog) -> UIView",
      "titleView": "(CallLog) -> UIView",
      "leadingView": "(CallLog) -> UIView",
      "trailView": "(CallLog) -> UIView"
    }
  },
  "events": [],
  "sdkListeners": [],
...
- [Call Buttons](/ui-kit/ios/call-buttons) - Voice and video call buttons
