...
description: "Guide to building a call log details screen in your iOS app using CometChat UI Kit with CometChatCallLogs and call detail components."
---
...
- **Key components:** `CometChatCallLogs`, call detail views
- **Import:** `import CometChatUIKitSwift`
- **Related:** [Call Logs](/ui-kit/ios/call-logs) · [Call Features](/ui-kit/ios/call-features) · [Guide Overview](/ui-kit/ios/guide-overview)
</Info>
