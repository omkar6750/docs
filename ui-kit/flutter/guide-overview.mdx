...
- [Search Messages](/ui-kit/flutter/guide-search-messages) → `CometChatSearch`
...
**Formatter Guides:**
- [Custom Text Formatter](/ui-kit/flutter/custom-text-formatter-guide) → `CometChatTextFormatter`
- [Mentions Formatter](/ui-kit/flutter/mentions-formatter-guide) → `CometChatMentionsFormatter`
- [URL Formatter](/ui-kit/flutter/url-formatter-guide) → `CometChatUrlFormatter`
- [Shortcut Formatter](/ui-kit/flutter/shortcut-formatter-guide) → `ShortcutFormatter`
