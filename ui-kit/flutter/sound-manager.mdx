---
title: "Sound Manager"
description: "Manage notification sounds and audio for messages and calls in Flutter UI Kit"
---
...
// Play custom sound
SoundManager().play(sound: Sound.incomingMessage, customSound: "custom.mp3");
```
</Info>
