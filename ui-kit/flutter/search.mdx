---
title: "Search"
description: "Search across conversations and messages with real-time filtering and customizable search scopes in Flutter"
---
...
// With common props
CometChatSearch(
  onItemTap: (conversation, message) {
...
<Note>
**Available via:** [UI Kits](/ui-kit/flutter/overview)
</Note>
