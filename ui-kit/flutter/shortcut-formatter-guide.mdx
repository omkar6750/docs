...
description: "Implement custom text shortcuts and replacements in messages with the ShortcutFormatter in Flutter"
---
...
<CardGroup cols={2}>
  <Card title="Mentions Formatter" icon="at" href="/ui-kit/flutter/mentions-formatter-guide">
    Format and style user mentions
  </Card>
  ...
  <Card title="Message List" icon="messages" href="/ui-kit/flutter/message-list">
    Display messages with formatted text
  </Card>
