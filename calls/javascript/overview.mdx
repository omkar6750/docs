...
The Calls SDK supports modern web browsers with WebRTC capabilities, including Chrome, Firefox, Safari, and Edge.
...
<Note>
  For native mobile apps, consider using the [iOS](/calls/ios/overview) or
  [Android](/calls/android/overview) SDKs for better performance and native
  features like CallKit/VoIP.
</Note>
...
<Card
  ...
  href="/calls/javascript/call-logs"
>
...
<Card
  ...
  icon="display"
  href="/calls/javascript/screen-sharing"
>
...
<Card
  ...
  icon="image"
  href="/calls/javascript/virtual-background"
>
...
| `SessionSettings`                 | TypeScript interface that provides type definitions for session settings                      |
| `CometChatCalls.addEventListener` | Method to register event listeners for session, participant, media, and UI events             |
