...
|----------|--------|-------------|
| [/calls](/rest-api/calls-apis/list-calls) | GET | List all calls with filtering options |
| [/calls/{sessionId}](/rest-api/calls-apis/get-call) | GET | Get details of a specific call |
