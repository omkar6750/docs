...
<CardGroup cols={3}>
  <Card title="React" icon={<img src="/images/icons/react.svg" alt="React" />} href="/ui-kit/react/core-features#message-moderation" horizontal />
...
For server-side integration and advanced moderation workflows:

<CardGroup cols={3}>
  <Card title="Flag Message" icon="flag" href="/rest-api/moderation/flag-a-message" horizontal />
  <Card title="List Flagged Messages" icon="list" href="/rest-api/moderation/list-flagged-messages" horizontal />
  <Card title="Approve/Block Message" icon="check" href="/rest-api/moderation/blockreview-flagged-message" horizontal />
  <Card title="Manage Rules" icon="gavel" href="/rest-api/moderation/create-rule" horizontal />
  <Card title="Manage Lists" icon="rectangle-list" href="/rest-api/moderation/create-list" horizontal />
  <Card title="Configure Reasons" icon="gear" href="/rest-api/moderation/create-reasons" horizontal />
</CardGroup>
...
|---------|-----------|----------|
| Create/manage rules | ✅ **Moderation > Rules** | [Rules API](/rest-api/moderation/create-rule) |
| Create/manage keyword lists | ✅ **Moderation > Lists** | [Lists API](/rest-api/moderation/create-list) |
| Review flagged messages | ✅ **Moderation > Flagged Messages** | [Flagged Messages API](/rest-api/moderation/list-flagged-messages) |
| View blocked messages | ✅ **Moderation > Blocked Messages** | [Blocked Messages API](/rest-api/moderation/list-blocked-messages) |
| Approve/block messages | ✅ Click action buttons | [Review API](/rest-api/moderation/blockreview-flagged-message) |
| Configure flag reasons | ✅ **Moderation > Advanced Settings** | [Reasons API](/rest-api/moderation/create-reasons) |
