---
title: "Stickers"
description: "Send and manage stickers in chat conversations with a built-in sticker manager."
---

Stickers lets users send visual stickers in conversations. The built-in sticker manager allows you to add, remove, and organize sticker sets directly from the dashboard.
