---
title: "Save Messages"
description: "Enable users to save messages from one-on-one and group conversations for later reference."
---

Save Messages lets users bookmark important messages in any conversation for later reference. Saved messages are private and visible only to the user who saved them.
