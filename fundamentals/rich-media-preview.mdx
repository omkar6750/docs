...
description: "Generate rich media previews for popular media links shared in chat conversations."
---

Rich Media Preview generates rich preview panels for popular sites. It fetches the first URL from a message and creates an embedded preview using Iframely.
