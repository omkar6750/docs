...
description: "Send pre-defined messages with configurable shortcuts for faster communication."
---

Message Shortcuts enables your users to send pre-defined messages using short codes. For example, typing **!hb** can automatically expand to **Happy birthday!**
