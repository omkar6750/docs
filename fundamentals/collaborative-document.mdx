...
description: "Allow users to create and share documents for real-time collaboration within conversations."
---

Collaborative Document enables users to create shared documents and collaborate in real time within conversations. The extension handles session creation and invitation delivery automatically.
