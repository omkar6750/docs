---
title: "Polls"
description: "Quickly ask for opinions in chats with interactive polls and view real-time results."
---

Polls let you quickly gather opinions directly within conversations. Create a question with multiple options, let participants vote, and view results in real time.
