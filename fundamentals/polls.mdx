...
<CardGroup cols={2}>
  ...
  <Card title="Notification configuration API" href="/rest-api/management-apis/extensions/polls-update-notification-configuration">
    Enable or disable push notifications for the Polls extension.
  </Card>
</CardGroup>
