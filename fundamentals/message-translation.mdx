...
description: "Translate text messages into different languages on the fly within chat conversations."
---

Message Translation enables real-time translation of messages into multiple languages, making it easy for multi-lingual teams and communities to communicate seamlessly.
