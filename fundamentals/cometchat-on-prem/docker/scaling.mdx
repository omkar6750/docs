...
Now that you understand scaling strategies, focus on maintaining and upgrading your scaled deployment:

**Next Step:**
- [Upgrades](./upgrades) - Perform zero-downtime upgrades and coordinate with scaling procedures

**Operational Procedures:**
- [Troubleshooting](./troubleshooting) - Diagnose performance issues before scaling

**Advanced Topics:**
- [Air-Gapped Deployment](./air-gapped-deployment) - Scale deployments in restricted network environments

**Capacity Planning Best Practices:**
- Monitor growth trends to predict when scaling is needed
- Scale proactively before hitting resource limits
- Test scaling procedures in staging before production
- Document scaling decisions and their impact
- Review capacity quarterly and adjust projections

**Critical next steps:**
1. **Set up monitoring** - Configure alerts for scaling triggers (CPU > 70%, memory > 85%)
2. **Establish baselines** - Document current performance metrics and capacity
3. **Create scaling runbooks** - Document procedures for scaling each service
4. **Test scaling** - Practice scaling in staging environment
5. **Plan capacity** - Project growth and plan scaling timeline

**Ready to maintain your deployment?** Proceed to [Upgrades](./upgrades) to learn how to perform zero-downtime upgrades while maintaining scale.
