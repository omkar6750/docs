...
Now that you understand upgrade procedures, prepare for operational issues and advanced deployments:

**Next Step:**
- [Troubleshooting](./troubleshooting) - Diagnose and resolve common operational issues

**Advanced Topics:**
- [Air-Gapped Deployment](./air-gapped-deployment) - Manage upgrades in restricted network environments
...
- Monitor system health closely after upgrades
- Keep previous image versions available for quick rollback

**Ready to handle issues?** Proceed to [Troubleshooting](./troubleshooting) to learn how to diagnose and resolve common operational problems.
