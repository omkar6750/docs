...
Now that you understand the CometChat On-Prem architecture and capabilities, proceed with planning and deployment:

**Next Step:**
- [Prerequisites](./prerequisites) - Review hardware requirements, network configuration, and dependency versions before deployment

**Complete Documentation Path:**
1. Prerequisites - Infrastructure and software requirements
2. [Configuration Reference](./configuration-reference) - Understand all configuration options and environment variables
3. [Quick Start](./quick-start) - Get a development environment running in minutes
4. [Production Deployment](./production-deployment) - Deploy a production-ready cluster with high availability
5. [Monitoring](./monitoring) - Set up comprehensive observability with Prometheus, Grafana, and Loki
6. [Security](./security) - Harden your deployment with security best practices
7. [Persistence & Backup](./persistence-and-backup) - Implement backup strategies and disaster recovery
8. [Scaling](./scaling) - Scale your deployment to handle growing workloads
9. [Upgrades](./upgrades) - Perform zero-downtime upgrades and rollbacks
10. [Troubleshooting](./troubleshooting) - Diagnose and resolve common issues
11. [Air-Gapped Deployment](./air-gapped-deployment) - Deploy in restricted network environments

**Ready to get started?** Begin with the [Prerequisites](./prerequisites) guide to ensure your infrastructure meets the requirements for a successful deployment.
