...
Now that you have monitoring configured, proceed with security hardening and operational procedures:
...
- [Scaling](./scaling) - Scale your deployment to handle growing workloads and optimize resource allocation
- [Upgrades](./upgrades) - Perform zero-downtime upgrades while monitoring system health
- [Troubleshooting](./troubleshooting) - Diagnose and resolve common operational issues using monitoring data

**Advanced Topics:**
- [Air-Gapped Deployment](./air-gapped-deployment) - Deploy monitoring stack in restricted network environments

**Ready to secure your deployment?** Proceed to [Security](./security) to implement TLS/SSL, secrets management, and network security controls.
