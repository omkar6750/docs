...
<CardGroup cols={2}>
  ...
  <Card title="Notification configuration API" href="/rest-api/management-apis/extensions/reminders-update-notification-configuration">
    Enable or disable push notifications for the Reminders extension.
  </Card>
</CardGroup>
