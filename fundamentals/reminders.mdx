---
title: "Reminders"
description: "Create reminders for messages or anything else within chat conversations."
---

Reminders let users set time-based reminders for messages or custom notes within conversations. A reminder bot delivers notifications at the scheduled time.
