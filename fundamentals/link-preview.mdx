---
title: "Link Preview"
description: "Automatically generate rich link previews for URLs shared in chat messages."
---

Link Preview automatically generates a preview of web pages for every link shared in your messages, showing the page description, favicon, and image.

While this extension gives you all the details required for generating a preview, the [Rich Media Preview](/fundamentals/rich-media-preview) extension provides a decorated iframe with styling.
