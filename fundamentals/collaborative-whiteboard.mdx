...
description: "Allow users to create and share whiteboards for real-time collaboration within conversations."
---

Collaborative Whiteboard enables users to create shared whiteboards and collaborate visually in real time within conversations. The extension handles session creation and invitation delivery automatically.
