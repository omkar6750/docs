...
- **Links** – Register canonical URLs for public or internal docs. _Coming soon._
- **Integrate** – Connect external systems or APIs to sync knowledge automatically. _Coming soon._

<Callout type="info" title="Coming soon">
Links and integration-based sources are surfaced in the UI today so you can plan your structure. They will activate as those ingestion methods roll out.
</Callout>
